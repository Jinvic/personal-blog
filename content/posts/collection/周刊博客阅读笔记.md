...
### 工作轨迹整理 Work Review |save

[Work Review](https://github.com/wm94i/Work_Review)
开源的 Win/Mac 桌面应用，在后台持续记录当天使用过的应用、访问过的网站等，便于整理成个人的工作轨迹。 |390
看起来有点用细想又不知道干啥。
...
跨平台的开源桌面 RSS 阅读器，支持自动翻译、自动总结、新订阅源发现。
folo目前差不多人人喊打，有空得迁移了。 |378
...
### Markdown编辑器 MarkFlowy |todo

[MarkFlowy](https://github.com/drl990114/MarkFlowy)
跨平台的 Markdown 桌面编辑器，内置 AI 支持，代码开源。
早就想找一个md编辑器，但兜兜转转又回到vscode。这回试试这个 |363
...
开源的浏览器翻译插件，根据设定的外语水平，帮助在日常网页浏览中自然地学外语。
试试|354
...
## Golang Weekly 【564-569】

Go社区公告&新闻

### 图表脚本语言 D2 |save

[d2](http://github.com/terrastruct/d2)
go编写的图表脚本语言，可以用于替代mermaid |566

### 文件树组件 treeview |save

[treeview](https://github.com/Digital-Shane/treeview)
文件树组件，以后学TUI可能用得上。 |565

### 一次性邮箱 Inbucket |save

一个可自托管的邮件测试服务——它接受任何邮箱地址的消息，并通过 Web、REST 和 POP3 接口提供这些消息。GitHub 仓库。
临时注册可以用，虽然国内基本都是用手机号的。|565

### cors中间件库 cors |save

cors: 一个基于原则的 CORS 中间件库——声称是“可能是最好的 Go 语言 CORS 中间件库”。
说不定以后工作会用上，存 |565

## Self-Host Weekly【2026-03-27 - 2026-01-16】
