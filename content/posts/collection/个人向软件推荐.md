...
- [chsrc](https://hellogithub.com/periodical/volume/101)
    全平台通用的换源工具。该项目能够为常见的 Linux 发行版、编程语言和软件切换至国内镜像源，操作简单仅需一条命令。
    服务器配置一下确实方便，不用手动改镜像地址了。只不过在wsl里没用，需要在docker desktop配置才行。
- [rime](https://rime.im/)
    全平台的开源输入法，被各种商业输入法恶心到可以试试这个。自定义配置项很丰富，虽然配置起来有点麻烦但配好后还是很好用的，基本的输入习惯都能通过自定义配置无缝迁移。
- [SumatraPDF](https://www.sumatrapdfreader.org/free-pdf-reader)
    一个超轻量的PDF查看工具。仅查看时可以使用这个，比等半天开一个WPS方便多了。强烈推荐。
...
- [ONLYOFFICE](https://github.com/ONLYOFFICE/DesktopEditors)
    ...
    试试能不能作为wps等的开源替代。本来我也只需要个查看功能。
    实际体验还行，简单需求都能胜任。只是占用还是很大。
