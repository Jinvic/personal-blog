...
- [x] [BetterLyrics](https://github.com/jayfunc/BetterLyrics)
    沉浸式桌面歌词显示工具。这是一款专为 Windows 设计的沉浸式歌词显示工具，能够自动识别播放器正在播放的音乐，实时检索本地或在线歌词，并通过流畅动画美观地展示在桌面上。
    之前用到lyrs是韩文的，不是很好用。这个无论是数据源，ui还是配置项都更胜一筹。
